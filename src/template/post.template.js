export function renderPost(post, options = {}) {
  ...
  const buttonFavorite = `<button class="button-round button-small button-primary prew" id = "" style="
  font-size: 14px; padding: 0 20px;" >Назад</button>`;
  return `
          <div class="panel">
            ...
            <div class="panel-footer w-panel-footer">
              ...
              ${options.withButton ? button : buttonFavorite}
            </div>
          </div>
      `;
}
